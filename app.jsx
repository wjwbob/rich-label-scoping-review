...
const level2Categories = [
  {
    ...
    papers: ["p01", "p02", "p03", "p05", "p06", "p07", "p08", "p09", "p10", "p11", "p12", "p13", "p14", "p15", "p16", "p17", "p18", "p19", "p20", "p21", "p22", "p23", "p26", "p27", "p29", "p32", "p33", "p34", "p35", "p37", "p38", "p40", "p41", "p43"]
  },
  {
    id: "context-setting",
    ...
    papers: ["p01", "p02", "p06", "p07", "p09", "p11", "p12", "p13", "p14", "p15", "p16", "p17", "p18", "p20", "p22", "p23", "p27", "p29", "p32", "p33", "p34", "p35", "p38", "p40", "p43"]
  },
  {
    id: "reasoning-causal",
    ...
    papers: ["p01", "p02", "p03", "p08", "p09", "p10", "p11", "p13", "p14", "p15", "p16", "p17", "p18", "p19", "p20", "p21", "p23", "p29", "p32", "p33", "p34", "p41"]
  },
  {
    ...
    papers: ["p01", "p05", "p06", "p07", "p11", "p12", "p13", "p14", "p22", "p23", "p26", "p27", "p34", "p38", "p40"]
  },
  {
    id: "other-low-frequency",
    title: "Other Low-frequency Richness Types",
    shortTitle: "Other",
    mark: "O",
    accent: "violet",
    summary: "Groups high-level richness types with fewer than 10 extracted labels in the final taxonomy.",
    anchors: "structured/schema representation; annotation process and metadata; personality/person-level traits; event-centered intent/effect/reaction",
    bullets: [
      "structured and schema-level representation",
      "annotation process, guideline, and quality metadata",
      "personality and person-level trait labels",
      "event-centered intent, effect, and reaction labels"
    ],
    papers: ["p01", "p02", "p05", "p10", "p11", "p12", "p16", "p17", "p18", "p20", "p22", "p26", "p27", "p29", "p34", "p37", "p38", "p40", "p43"],
    subcategories: [
      {
        title: "Structured and schema-level representation",
        count: 8,
        articleCount: 6,
        summary: "Machine-readable, graph, spatial, schema-level, class-level, or label-relation representations that enrich the label space or instance representation.",
        lowLevels: "Spatial, graph, and structural representation labels; class/schema semantic representation labels",
        papers: ["p20", "p22", "p27", "p37", "p38", "p40"]
      },
      {
        title: "Annotation process, guideline, and quality metadata",
        count: 7,
        articleCount: 5,
        summary: "Information about how labels are produced, constrained, judged, prompted, or quality-controlled.",
        lowLevels: "Annotation quality, uncertainty, and metadata; annotation guideline and decision-rule labels",
        papers: ["p01", "p02", "p05", "p11", "p12"]
      },
      {
        ...
        lowLevels: "Personality, trait",
        papers: ["p16", "p17", "p18", "p29", "p34", "p43"]
      },
      {
        title: "Event-centered intent, effect, and reaction labels",
        count: 5,
        articleCount: 2,
        summary: "Labels that describe inferred intent, likely effect, or reaction of the speaker or others around an affective event, including COMET/ATOMIC-style relation cues.",
        lowLevels: "Intent, effect, and reaction labels; COMET commonsense cues",
        papers: ["p10", "p26"]
      }
    ]
  }
